...
import info.tregminehub.api.encryption.BCrypt;
...
public class TregminePlayer extends PlayerDelegate {
	...
	public boolean hasBlockPermission(){
		return this.rank == Rank.BUILDER || this.rank == Rank.JUNIOR_ADMIN || this.rank == Rank.SENIOR_ADMIN;
	}
	
	public boolean hasBlockPermission(Location x, boolean t){
		return this.rank == Rank.BUILDER || this.rank == Rank.JUNIOR_ADMIN || this.rank == Rank.SENIOR_ADMIN;
	}
